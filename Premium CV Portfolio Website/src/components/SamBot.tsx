    ...
    <section id="sambot" className="py-32 px-6 bg-gradient-to-b from-white via-slate-50 to-white" ref={ref}>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="w-20 h-1 mx-auto bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full mb-4" />
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-100 to-purple-100 rounded-3xl blur-xl opacity-50" />
          <div className="relative backdrop-blur-sm bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden">
            {/* Header */}
            <div className="px-6 py-4 bg-gradient-to-r from-cyan-50 to-purple-50 border-b border-slate-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full blur-md animate-pulse" />
                    <div className="relative p-2 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full">
                ...
                <div>
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-lg text-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed hover:from-cyan-400 hover:to-purple-400 transition-all"
                  >
              ...
              {uploadedFiles.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {uploadedFiles.map((file, index) => (
                    <div
                      key={index}
                      className="px-3 py-1 bg-white rounded-full text-xs text-slate-700 border border-cyan-200 flex items-center gap-2"
                    >
                      <span>📄 {file}</span>
                    </div>
                  ))}
                      ...
                      <div className="mt-2 pt-2 border-t border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {message.citations.map((citation, idx) => (
                            <span
                              key={idx}
                              className="px-2 py-0.5 bg-cyan-100 text-cyan-700 rounded text-xs"
                            >
                              {citation}
                            </span>
                          ))}
            ...
            <div className="p-6 border-t border-slate-200 bg-white">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-cyan-400 transition-colors"
                />
                <motion.button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:from-cyan-400 hover:to-purple-400 transition-all shadow-lg shadow-cyan-500/20"
                >
