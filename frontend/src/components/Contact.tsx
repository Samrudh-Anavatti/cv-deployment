...
export function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+44 7417 424593',
      href: 'tel:+447417424593',
    },
    {
      icon: MapPin,
      label: 'Location',
    ...
    <section id="contact" className="py-32 px-6 bg-gradient-to-b from-white via-slate-50 to-white">
      <div className="max-w-4xl mx-auto" ref={ref}>
        ...
        >
          ...
          <div className="w-20 h-1 mx-auto mb-6 bg-gradient-to-r from-sage-500 to-skyblue-600 rounded-full" />
          <p className="text-slate-600 max-w-2xl mx-auto">
            I'm always open to discussing new projects, ideas, or opportunities to be part of. Feel free to reach out!
          </p>
        </motion.div>
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-sage-300 to-navy-300 rounded-2xl blur-xl opacity-50" />
            <div className="relative backdrop-blur-sm bg-white border border-slate-200 rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4 mb-8">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="p-3 bg-gradient-to-br from-sage-300/50 to-navy-300/50 rounded-xl group-hover:from-sage-300 group-hover:to-navy-300 transition-colors">
                      <info.icon className="w-5 h-5 text-sage-500" />
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="p-3 bg-slate-50 hover:bg-gradient-to-br hover:from-sage-300/50 hover:to-navy-300/50 border border-slate-200 hover:border-sage-500 rounded-xl transition-all"
                      aria-label={social.label}
                    >
                      <social.icon className="w-5 h-5 text-slate-600 group-hover:text-sage-500" />
                    </motion.a>
                  ))}
                </div>
              </div>
        ...
        >
          <p className="text-slate-500">
            © 2025 Samrudh Anavatti. Built with React, TypeScript, Vite, and Claude.
          </p>
        </motion.div>
      </div>
    </section>
